...
async def main_devchecker():
    async with app:
            while True:
                print("Checking...")
                xxx_teletips = f"<u>**🏷 ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ Tᴇᴀᴍ Rᴇᴍᴏ\ɴ ɪɴғᴏʀᴍᴀᴛɪᴏɴ ᴄʜᴀɴɴᴇʟ**</u>\n\n 📈 | <u>**ʀᴇᴀʟ ᴛɪᴍᴇ ʙᴏᴛ's sᴛᴀᴛᴜs 🍂**</u>"
                for bot in BOT_LIST:
                    ...
                    try:
                        ...
                        if aaa == bbb:
                            ...
                            for bot_admin_id in BOT_ADMIN_IDS:
                                try:
                                    await app.send_message(int(GRP_ID), f"**ʙᴏᴛ ɪs ᴏғғʟɪɴᴇ ᴄʜᴇᴄᴋ ᴘᴀɴᴜ ᴅᴀ ᴘᴀᴋᴋɪɪ 😡\n[{bot_info.first_name}](tg://user?id={bot_info.id}) ʙᴏᴛ ᴏғғ ᴀᴄʜᴜ ᴘᴏɪ ᴄʜᴇᴄᴋ ᴘᴀɴᴜ.**")
                                except Exception:...
